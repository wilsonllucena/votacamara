      ...
      <div className="container mx-auto px-4 md:px-6">
        ...
        <div className="relative flex flex-col items-center justify-center perspective-[1000px]">
          ...
          >
            ...
            <div className="w-[1000px] h-[600px] bg-slate-950 p-1 rounded-xl ring-1 ring-white/10 relative overflow-hidden font-sans">
                <div className="flex h-full w-full bg-slate-950 rounded-lg overflow-hidden flex-col">
                    ...
                    <div className="bg-slate-900 border-b border-slate-800 p-6 flex justify-between items-center">
                        <div>
                            ...
                            <h3 className="text-xl font-bold text-white">Projeto de Lei Complementar - Segurança Pública</h3>
                        </div>
                        <div className="flex items-center gap-6">
                            <div className="text-center">
                                <span className="block text-2xl font-bold text-green-500">12</span>
                                <span className="text-xs text-slate-500 font-bold uppercase">Sim</span>
                            </div>
                             <div className="text-center">
                                <span className="block text-2xl font-bold text-red-500">4</span>
                                <span className="text-xs text-slate-500 font-bold uppercase">Não</span>
                            </div>
                             <div className="text-center">
                                <span className="block text-2xl font-bold text-yellow-500">1</span>
                    ...
                    <div className="flex-1 p-6 bg-slate-950 overflow-hidden">
                        <div className="grid grid-cols-4 gap-4">
                            {[
                                ...
                                <div key={i} className="bg-slate-900/40 border border-slate-800 rounded-lg p-3 flex items-center gap-3 hover:bg-slate-900/60 transition-colors">
                                    <div className={`w-12 h-12 rounded-full ${councilor.photo} border-2 border-slate-800 flex-shrink-0 flex items-center justify-center text-xs text-slate-400 font-bold`}>
                                        {councilor.name.charAt(0)}
                                    </div>
                                    <div className="flex-1 min-w-0">
                                        <h4 className="text-sm font-semibold text-slate-200 truncate">{councilor.name}</h4>
                                        <p className="text-xs text-slate-500">{councilor.party}</p>
                                    </div>
                                    <div className={`px-2 py-1 rounded text-[10px] font-bold uppercase tracking-wider min-w-[50px] text-center
                    ...
                    {/* Bottom Bar */}
                    <div className="h-12 bg-slate-900 border-t border-slate-800 flex items-center justify-between px-6 text-xs text-slate-500">
            ...
            <motion.div 
                ...
                className="mt-12 relative w-[1000px] h-[600px] bg-slate-950 rounded-xl ring-1 ring-white/10 shadow-2xl overflow-hidden flex flex-col z-20 mx-auto"
            >
                {/* Tablet Header */}
                <div className="bg-slate-900/80 backdrop-blur border-b border-slate-800 p-6 flex items-center justify-between">
                     <div className="flex items-center gap-4">
                        <div className="w-12 h-12 rounded-full bg-blue-500/20 flex items-center justify-center text-blue-400 font-bold text-lg">CS</div>
                        <div>
                            <div className="text-lg font-bold text-white">Carlos Silva</div>
                            <div className="text-sm text-slate-400">PSD - Vereador</div>
                        </div>
                     </div>
                     <div className="flex items-center gap-3 bg-green-500/10 px-4 py-2 rounded-full border border-green-500/20">
                         <div className="w-2.5 h-2.5 rounded-full bg-green-500 animate-pulse"></div>
                         <span className="text-green-500 font-bold text-sm uppercase tracking-wide">Votação Aberta</span>
                     </div>
                </div>

                {/* Tablet Body */}
                <div className="flex-1 p-8 grid grid-cols-2 gap-12 items-center bg-slate-950">
                    {/* Left Column: Project Info */}
                    <div className="space-y-8">
                        <div className="space-y-4">
                            <span className="text-slate-500 text-lg font-medium">PL 123/2024</span>
                            <h3 className="text-4xl font-bold text-white leading-tight">
                                Projeto de Lei Complementar - Segurança Pública e Monitoramento Urbano
                            </h3>
                        ...
                        <div className="p-6 bg-slate-900/50 rounded-xl border border-slate-800 space-y-4">
                            <div className="flex justify-between items-center text-slate-400">
                                <span className="font-medium">Tempo Restante para Voto</span>
                                <span className="text-white font-mono text-2xl font-bold">04:32</span>
                            </div>
                    ...
                    <div className="flex flex-col gap-4 max-w-md mx-auto w-full">
                         <div className="text-center text-slate-400 mb-2 font-medium">Selecione sua opção de voto</div>
                         
                         <button className="group w-full py-8 rounded-2xl bg-green-600/10 hover:bg-green-600 text-green-500 hover:text-white border-2 border-green-600/50 hover:border-green-600 transition-all duration-300 flex items-center justify-between px-8">
                             <span className="text-2xl font-bold">SIM</span>
                             <div className="w-10 h-10 rounded-full border-2 border-current flex items-center justify-center group-hover:bg-white/20">
                         ...
                         <button className="group w-full py-8 rounded-2xl bg-red-600/10 hover:bg-red-600 text-red-500 hover:text-white border-2 border-red-600/50 hover:border-red-600 transition-all duration-300 flex items-center justify-between px-8">
                          ...
                          <button className="w-full py-6 rounded-2xl bg-slate-800/50 hover:bg-slate-800 text-slate-400 hover:text-white border border-slate-700 hover:border-slate-600 transition-all font-semibold flex items-center justify-center gap-2">
