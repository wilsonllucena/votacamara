...
export function PasswordSettingsForm({ onSubmit, isPending }: PasswordSettingsFormProps) {
  const {
    register,
    handleSubmit,
    reset,
  ...
  return (
    <form onSubmit={handleSubmit(onFormSubmit)} className="max-w-md space-y-6">
      ...
      <div className="space-y-4">
        <div className="space-y-2">
            ...
            <input 
              ...
              id="newPassword"
              type="password" 
              className={`w-full bg-background border ${errors.newPassword ? 'border-red-500' : 'border-border'} rounded-lg px-4 py-2 text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all`}
              placeholder="••••••••"
            />
        ...
        <div className="space-y-2">
            ...
            <input 
              ...
              id="confirmPassword"
              type="password" 
              className={`w-full bg-background border ${errors.confirmPassword ? 'border-red-500' : 'border-border'} rounded-lg px-4 py-2 text-foreground focus:outline-none focus:ring-2 focus:ring-primary/50 transition-all`}
              placeholder="••••••••"
            />
