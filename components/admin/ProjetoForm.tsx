                ...
                <div className="space-y-4">
                    ...
                    <div className="space-y-2">
                        ...
                        <textarea
                            ...
                            className="flex min-h-[100px] w-full rounded-md border border-slate-800 bg-slate-950 px-3 py-2 text-sm text-white focus:outline-none focus:ring-2 focus:ring-blue-500/50"
